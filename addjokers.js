...
let wicked_jokers = [
  ...
  },
  {
    name: "Bend Down",
    text: [
      "Decreases Blind size by {C:attention}% of discards{} remaining",
    ],
  ...
  },
  {
    name: "Damage",
    text: [
      "Every {C:attention}other{} card in played hand gives {C:mult}+3{} Mult and has {C:green}1 in 3{} chance to be destroyed when scored",
    ],
